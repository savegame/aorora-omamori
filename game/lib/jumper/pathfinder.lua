...
if (...) then
  ...
  function Pathfinder:getPath(startX, startY, endX, endY, clearance, overrideHeuristic, overrideCostEval)
		self:reset()
    ...
    local _endNode = Finders[self._finder](self, startNode, endNode, clearance, toClear, overrideHeuristic, overrideCostEval)
    if _endNode then
